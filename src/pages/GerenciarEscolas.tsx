    ...
    const fetchEscolas = async () => {
        ...
        try {
            ...
            const mockEscolas: Escola[] = [
                {
                    id: "1",
                    nome: "EMEF Professora Maria José",
                    codigo: "35012345",
                    ...
                    email: "contato@emefmarijose.edu.br",
                    site: "www.emefmarijose.edu.br",
                    diretor: "Dra. Ana Paula Souza",
                    tipo: "municipal",
                    niveisEnsino: ["Ensino Fundamental I", "Ensino Fundamental II"],
                    totalAlunos: 850,
                    totalProfessores: 45,
                    totalTurmas: 28,
                    status: "ativa",
                    dataCriacao: "2005-03-15",
                    observacoes: "Escola referência em educação inclusiva"
                },
                {
                    id: "2",
                    nome: "EEEM Dom Pedro II",
                    codigo: "35054321",
                    endereco: "Avenida Brasil, 500",
                    cidade: "Belém",
                    estado: "PA",
                    cep: "66000-100",
                    telefone: "(91) 3245-6789",
                    email: "secretaria@dompedroii.edu.br",
                    site: "www.dompedroii.edu.br",
                    diretor: "Prof. Carlos Alberto Santos",
                    tipo: "estadual",
                    niveisEnsino: ["Ensino Fundamental II", "Ensino Médio", "EJA"],
                    totalAlunos: 1250,
                    totalProfessores: 68,
                    totalTurmas: 42,
                    status: "ativa",
                    dataCriacao: "1950-02-10",
                    observacoes: "Escola centenária com ensino de excelência"
                },
                {
                    id: "3",
                    nome: "Colégio Santa Luzia",
                    codigo: "35123456",
                    endereco: "Rua Padre Eutíquio, 789",
                    cidade: "Ananindeua",
                    estado: "PA",
                    cep: "67000-000",
                    telefone: "(91) 3278-9012",
                    email: "contato@santaluzia.com.br",
                    site: "www.santaluzia.com.br",
                    diretor: "Irmã Inês Maria",
                    tipo: "privada",
                    niveisEnsino: ["Ensino Fundamental I", "Ensino Fundamental II", "Ensino Médio"],
                    totalAlunos: 620,
                    totalProfessores: 35,
                    totalTurmas: 22,
                    status: "ativa",
                    dataCriacao: "1985-08-20"
                },
                {
                    id: "4",
                    nome: "EEFM Prof. João Batista",
                    codigo: "35123457",
                    endereco: "Rua do Comércio, 45",
                    cidade: "Santarém",
                    estado: "PA",
                    cep: "68000-000",
                    telefone: "(93) 3522-3344",
                    email: "joaobatista@educacao.pa.gov.br",
                    diretor: "Profa. Lúcia Helena Mendes",
                    tipo: "estadual",
                    niveisEnsino: ["Ensino Médio", "Educação Profissional Técnica"],
                    totalAlunos: 980,
                    totalProfessores: 52,
                    totalTurmas: 34,
                ...
                {
                    id: "5",
                    nome: "EMEF Alberto Santos",
                    codigo: "35123458",
                    endereco: "Travessa São Pedro, 200",
                    cidade: "Castanhal",
                    estado: "PA",
                    cep: "68700-000",
                    telefone: "(91) 3721-4455",
                    email: "santos@educacao.castanhal.pa.gov.br",
                    diretor: "Prof. Raimundo Nonato",
                    tipo: "municipal",
                    niveisEnsino: ["Ensino Fundamental I", "Ensino Fundamental II"],
                    totalAlunos: 720,
                    totalProfessores: 38,
                                    ...
                                    <td style={styles.tableCell}>
                                        <div style={styles.niveisList}>
                                            {escola.niveisEnsino.slice(0, 2).map(nivel => (
                                                <span key={nivel} style={styles.nivelChip}>{nivel}</span>
                                            ))}
                                            {escola.niveisEnsino.length > 2 && (
                                                <span style={styles.nivelMais}>+{escola.niveisEnsino.length - 2}</span>
                                            )}
                                        </div>
                                    </td>
                                    <td style={styles.tableCell}>
